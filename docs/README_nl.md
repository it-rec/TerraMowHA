...
- Vertaald in 14 talen (en, cs, da, de, es, fi, fr, it, nb, nl, pl, pt, sv, zh-Hans)
...
De integratie is vertaald in: Čeština, Dansk, Deutsch, English, Español, Français, Italiano, Nederlands, Norsk (bokmål), Polski, Português, Suomi, Svenska en 简体中文.
...
Open een issue op [GitHub](https://github.com/TerraMow/TerraMowHA/issues) voor ondersteuning.
