...
class TerramowMapCard extends HTMLElement {
  ...
  _buildLegend() {
    ...
    add(subs.some((s) => !s.selected), "zone", "lg_zone");
    add(subs.some((s) => s.selected), "zone_selected", "lg_zone_selected");
