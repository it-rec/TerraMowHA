...
PLATFORMS: list[Platform] = [Platform.LAWN_MOWER, Platform.SENSOR, Platform.BINARY_SENSOR, Platform.SELECT, Platform.NUMBER, Platform.CAMERA, Platform.UPDATE, Platform.BUTTON, Platform.SWITCH, Platform.LIGHT, Platform.EVENT, Platform.CALENDAR]
